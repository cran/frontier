...
all.equal( sbb5ecf[-38], bb5ecf[-38] )
...
all.equal( sbb6ecf[-38], bb6ecf[-38] )
...
b5eef <- frontier( data = riceProdPhil,
   yName = "lPROD", xNames = c( "lAREA", "lLABOR", "lNPK" ),
   zNames = NA )
all.equal( sb5eef[-38], b5eef[-38] )
all.equal( b5eef[ -c( 3, 4, 19, 30, 38 ) ], bb5eef[ -c( 3, 4, 19, 30, 38 ) ] )
...
all.equal( sb6ecf[-38], b6ecf[-38] )
all.equal( b6ecf[-38], bb6ecf[-38] )
...
b6eef <- frontier( data = riceProdPhil,
   yName = "lPROD", xNames = c( "lAREA", "lLABOR", "lNPK" ),
   zIntercept = TRUE, zNames = NA )
all.equal( sb6eef[-38], b6eef[-38] )
all.equal( b6eef[ -c( 3, 4, 19, 30, 38 ) ], bb6eef[ -c( 3, 4, 19, 30, 38 ) ] )
